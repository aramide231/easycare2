...
import cardPattern from "@hmo/assets/image/dashboard-card-pattern.png";
import notificationPattern from "@hmo/assets/image/dashboard-card-pattern-notification.png";
...
const HmoSummaryCard = ({
  ...
  return (
    <Wrapper
      ...
      onClick={onNavigate}
      className={cn(
        "relative flex w-full overflow-hidden rounded-lg text-left shadow-md sm:w-1/3",
        isClickable &&
          "transition hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#573FD1] focus-visible:ring-offset-2",
        isNotification
