...
/** Figma pharmacy pagination: Back · 1 2 3 4 … 20 30 40 50 60 70 · Next */
const FIGMA_PAGE_ITEMS = [1, 2, 3, 4, "ellipsis", 20, 30, 40, 50, 60, 70] as const;

export default function PharmacyTablePagination({
  currentPage,
  totalPages = 70,
  onPageChange,
  className,
  ...
  return (
    ...
    >
      ...
      {FIGMA_PAGE_ITEMS.map((item, index) =>
        item === "ellipsis" ? (
          <span
            key={`ellipsis-${index}`}
