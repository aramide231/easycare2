...
export type RequestMedicationsHandle = {
  getMedications: () => PickedMedication[];
  reset: () => void;
  hasMedications: () => boolean;
};

const RequestMedicationsSection = forwardRef<RequestMedicationsHandle>(
  function RequestMedicationsSection(_props, ref) {
    ...
    useImperativeHandle(ref, () => ({
      getMedications: () => picked,
      reset: resetAll,
      hasMedications: () => picked.length > 0,
    }));
            ...
            <table className="min-w-full text-left text-sm">
              ...
              <tbody>
                {picked.map((item, index) => (
                  <tr key={item.id} className="border-b border-gray-100">
                    ...
                    <td className="px-4 py-3">{item.adminRoute}</td>
                    ...
                    <td className="px-4 py-3">
                      {formatMedicationNaira(item.lineTotal)}
                    </td>
                    <td className="px-4 py-3">
                      <button
                        type="button"
              ...
              <tfoot>
                <tr className="bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm font-semibold text-[#573FD1]">
                    {formatMedicationNaira(totalAmount)}
                  </td>
                  <td />
                </tr>
              </tfoot>
...
export default RequestMedicationsSection;
