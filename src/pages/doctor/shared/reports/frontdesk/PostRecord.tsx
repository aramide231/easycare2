...
import { Input } from "@doctor-shared/components/Input";
...
const PostRecord = () => {
  ...
  const isValidCounsellingType = (type: string): type is "DONE" | "NOT DONE" =>
    ["DONE", "NOT DONE"].includes(type);
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 ">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <ExportButton reportTitle="Export all Post Natal Report" />
        </div>
      </div>
                ...
                .map((patient, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`${
                          isValidCounsellingType(patient.counselling)
                            ? getCounsellingTypeClass(patient.counselling)
                            : "bg-[#e6faee] text-[#33d374] border-[#33d374]"
