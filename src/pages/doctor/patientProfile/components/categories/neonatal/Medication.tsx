        ...
        <table className="min-w-max w-full text-left text-sm">
          ...
          <tbody>
            {history.length === 0 ? (
              <tr>
                <td
                  colSpan={TREATMENT_COLUMNS.length + 1}
              ...
              history.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">{row.duration as string}</td>
                  <td className="px-4 py-3">{row.period as string}</td>
