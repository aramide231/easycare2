...
export default function PostNatalInvestigation() {
  const [investigation, setInvestigation] = useState("");
  const [price, setPrice] = useState("");
  const [items, setItems] = useState<InvestigationItem[]>([]);

  const { history, save, remove } = useMedicalTable("POST NATAL — INVESTIGATION");
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end gap-3">
        <div className="min-w-[200px] flex-1">
          ...
          <input
            list="post-natal-investigation-tariffs"
            value={investigation}
          ...
          />
          <datalist id="post-natal-investigation-tariffs">
